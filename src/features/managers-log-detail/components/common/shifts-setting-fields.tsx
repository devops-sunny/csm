...
export const ShiftsSettingFields = () => {
  ...
  return [
    ...
    <FormControl key={label}>
      ...
      <SearchCheckbox
        ...
        onSelect={(options) => {
          const selectedUserIds = options.map((item) => item.value);

          handleChangeShifts(updateKey, selectedUserIds);
        }}
