...
import { MobileActionsDrawer } from '@features/employees-listing/components/modals-drawers/mobile-actions-drawer';
import { MobileNewEmployeeDrawer } from '@features/employees-listing/components/modals-drawers/mobile-new-employee-drawer';
import {
  mobileOpenNewEmployeePanelAtom,
  mobileToolbarOptionPanelAtom,
} from '@features/employees-listing/states/common';
import {
  mobileOpenSearchDrawerAtom,
  mobileOpenFiltersDrawerAtom,
  mobileOpenSortDrawerAtom,
  mobileOpenNewEmployeeDrawerAtom,
...
export const MobileFooterAction: FunctionComponent = () => {
  ...
  const newLogActive = useAtomValue(mobileOpenNewEmployeeDrawerAtom);
  ...
  const closeAllActionDrawers = () => {
    ...
    defaultStore.set(mobileOpenNewEmployeeDrawerAtom, false);
    ...
    >
      ...
      >
        ...
        >
          ...
          <IconButton
            onClick={() => {
              handleTriggerDrawers(mobileOpenNewEmployeeDrawerAtom);
            }}
            sx={{
              ...(newLogActive && {
                backgroundColor: theme.palette.blueberry,
